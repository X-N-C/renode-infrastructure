...
namespace Antmicro.Renode.Peripherals.CF2
{
    public class EEPROM : II2CPeripheral
    {
        ...
        public void Write(byte[] data)
        {
         ...
         {
             this.Log(LogLevel.Noisy, "Trying to write byte {0} (0x{1:X})", i, data[i]);
         }
        ...
        private byte[] data = new byte[8192]{0x30, 0x78, 0x42, 0x43, 0x01, 0x50, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE7, 0xE7, 0xE7, 0xE7, 0xE7, 0x03};
